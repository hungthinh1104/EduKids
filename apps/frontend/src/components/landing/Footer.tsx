...
export function Footer() {
    return (
        <footer className="bg-background text-muted pt-24 pb-12 px-6 border-t border-border">
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 md:gap-12 mb-16">
                <div className="col-span-2 md:col-span-1 pr-0 sm:pr-4 lg:pr-12">
                    ...
                    <Body className="text-base leading-relaxed mb-8">
                ...
                <div>
                    <Heading level={4} className="text-heading font-bold font-heading mb-6 text-xl">Nền Tảng</Heading>
                ...
                <div>
                    <Heading level={4} className="text-heading font-bold font-heading mb-6 text-xl">Hỗ Trợ</Heading>
                    <ul className="space-y-4">
                ...
                <div>
                    <Heading level={4} className="text-heading font-bold font-heading mb-6 text-xl">Đăng Ký Nhận Tin</Heading>
                    <Body className="text-sm mb-4">Nhận giáo án và bài tập mầm non miễn phí mỗi tuần qua Email.</Body>
                    <div className="flex gap-2 border border-border rounded-full p-1.5 bg-card/70 focus-within:border-primary transition-colors overflow-hidden">
