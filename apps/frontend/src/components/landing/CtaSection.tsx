...
export function CtaSection() {
    ...
    return (
        <section className="py-24 relative overflow-hidden">
            ...
            >
                <div className="inline-flex justify-center items-center w-16 h-16 sm:w-20 sm:h-20 bg-card/20 rounded-3xl backdrop-blur-md mb-6 sm:mb-8 shadow-2xl border border-white/30">
                    <Trophy size={40} className="text-white fill-white/50" />
                </div>
                <Heading level={2} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white mb-6 sm:mb-8 font-black font-heading tracking-wide drop-shadow-lg">
                    Khóa Cửa Tương Lai. <br /> Mở Ra Bằng Tiếng Anh!
                </Heading>
                <Body className="text-lg sm:text-xl md:text-2xl mb-8 sm:mb-12 px-4 text-white/90 font-medium max-w-2xl mx-auto leading-relaxed">
                ...
                <Link href={targetHref}>
                    <button className="bg-card text-primary text-lg sm:text-2xl font-bold px-6 sm:px-12 py-4 sm:py-6 rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.2)] hover:shadow-[0_20px_50px_rgba(255,255,255,0.3)] hover:-translate-y-2 transition-all duration-300 transform inline-flex items-center gap-3">
