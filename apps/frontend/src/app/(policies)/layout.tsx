...
export default function PoliciesLayout({
    ...
    return (
        <div className="min-h-screen bg-background overflow-hidden relative pb-24">
            ...
            <header className="bg-card border-b border-border py-6 sticky top-0 z-40 backdrop-blur-sm bg-card/80 dark:bg-card/80">
