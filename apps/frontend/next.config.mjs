...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "img-src 'self' data: blob: https://res.cloudinary.com https://api.dicebear.com https://loremflickr.com https://images.unsplash.com https://www.transparenttextures.com",
