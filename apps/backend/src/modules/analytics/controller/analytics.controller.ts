...
import { AnalyticsQueryDto, ContentPopularityQueryDto } from '../dto/analytics-query.dto';
import {
  DAUResponseDto,
...
export class AnalyticsController {
  ...
  @ApiOperation({
    ...
    description: 'Get real-time dashboard metrics including DAU, sessions, and top content',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retrieve daily active users metrics with trends and comparisons',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retrieve most popular content with views, engagement, and completion stats',
  })
  @ApiResponse({
    status: 200,
